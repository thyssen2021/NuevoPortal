...
{
    [Authorize]
    public class IT_wsusController : BaseController
    {
        ...
        public ActionResult LoadFile(ExcelViewModel excelViewModel, FormCollection collection)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    List<IT_wsus> lista = UtilExcel.LeeWSUS(excelViewModel.PostedFile, ref msj);
                    ...
                    {
                        //truncate a tabla
                        db.Database.ExecuteSqlCommand("TRUNCATE TABLE [IT_wsus]");
                        //inserta nuevos registros
                        db.IT_wsus.AddRange(lista);
