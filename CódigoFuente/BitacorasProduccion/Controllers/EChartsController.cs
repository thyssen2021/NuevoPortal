...
namespace Portal_2_0.Controllers
{
    ...
    public class EChartsController : BaseController
    {
        ...
        /// <summary>
        /// Obtiene el total de todas las regiones excepto export
        /// </summary>
        public ContentResult GetChartIHS_SOP(string country_territory, string manufacturer, string production_plant, string vehicle, string origen, string demanda = Bitacoras.Util.BG_IHS_tipo_demanda.CUSTOMER)
        {
            ...
            for (int i = 0; i < cabeceraAnios.Count; i++)
            {
                ...
                int? cantidad = listDatos.Where(x => x.anio == (cabeceraAnios[i].anio - 1) && x.region != "EXPORT").Sum(x => x.cantidad);
