...
{
    [Authorize]
    public class budget_rel_tipo_cambio_fy_forecastController : BaseController
    {
        private Portal_2_0Entities db = new Portal_2_0Entities();

        // GET: budget_rel_tipo_cambio_fy_forecast
        public ActionResult Index()
        {
            ...
            var rates = db.budget_rel_tipo_cambio_fy_forecast
        ...
        // GET: budget_rel_tipo_cambio_fy_forecast/Edit/5
        ...
        public JsonResult SaveFiscalRates(List<FiscalRateViewModel> rates, int id_fy)
        {
            ...
            foreach (var rate in rates)
            {
                ...
                var recordUsdMxn = db.budget_rel_tipo_cambio_fy_forecast.FirstOrDefault(r =>
                    r.id_budget_anio_fiscal == id_fy && r.mes == rate.mes && r.id_tipo_cambio == 1);

                var recordEurUsd = db.budget_rel_tipo_cambio_fy_forecast.FirstOrDefault(r =>
            ...
            foreach (var mes in mesesModificados)
            {
                db.Database.ExecuteSqlCommand(
                     "EXEC usp_ActualizarBudgetCantidadForecast @id_fy, @month",
