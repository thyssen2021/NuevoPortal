...
{
    public class FooterEventHandlerPDF_IT_checklist_equipos : IEventHandler
    {
        PdfFont fontThyssen;
        IT_equipos_checklist check;
        string claveDocumento;
        public FooterEventHandlerPDF_IT_checklist_equipos(PdfFont font, IT_equipos_checklist check)
        {
            this.fontThyssen = font;
            this.check = check;
            //this.claveDocumento = check.IATF_revisiones.IATF_documentos.clave + "-" + check.IATF_revisiones.numero_revision.ToString("D2");
            this.claveDocumento = String.Empty;
        }
