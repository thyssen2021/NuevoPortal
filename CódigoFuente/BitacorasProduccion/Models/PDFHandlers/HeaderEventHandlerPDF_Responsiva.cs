...
{
    public class HeaderEventHandlerPDF_Responsiva : IEventHandler
    {
        Image img;
        PdfFont fontThyssen;
        IT_asignacion_hardware asignacion;

        public HeaderEventHandlerPDF_Responsiva(Image img, PdfFont font, IT_asignacion_hardware asignacion)
        {
            this.img = img;
        ...
        public Table GetTable(PdfDocumentEvent docEvent)
        {
            ...
            cell = new Cell()
               .Add(new Paragraph(asignacion.IATF_revisiones.IATF_documentos.nombre_documento)).SetFont(fontThyssen)
