...
{
    public class FooterEventHandlerPDF_Responsiva : IEventHandler
    {
        PdfFont fontThyssen;
        IT_asignacion_hardware asignacion;
        string claveDocumento;
        public FooterEventHandlerPDF_Responsiva(PdfFont font, IT_asignacion_hardware asignacion)
        {
            this.fontThyssen = font;
            this.asignacion = asignacion;
            this.claveDocumento = asignacion.IATF_revisiones.IATF_documentos.clave + "-" + asignacion.IATF_revisiones.numero_revision.ToString("D2"); 
        }
