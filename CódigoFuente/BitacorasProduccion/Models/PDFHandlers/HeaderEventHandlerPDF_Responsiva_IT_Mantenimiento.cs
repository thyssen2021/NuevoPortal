...
{
    public class HeaderEventHandlerPDF_Mantenimiento : IEventHandler
    {
        Image img;
        PdfFont fontThyssen;
        IT_mantenimientos mantenimiento;

        public HeaderEventHandlerPDF_Mantenimiento(Image img, PdfFont font, IT_mantenimientos mantenimiento)
        {
            this.img = img;
        ...
        public Table GetTable(PdfDocumentEvent docEvent)
        {
            ...
            cell = new Cell()
               .Add(new Paragraph(mantenimiento.IATF_revisiones.IATF_documentos.nombre_documento)).SetFont(fontThyssen)
