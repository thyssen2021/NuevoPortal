...
namespace Portal_2_0.Models
{
    public class BG_Forecast_itemMetadata
    {
        ...
        [MaxLength(100)]
        [Display(Name = "Additional Process")]
        ...
        //nuevos campos
        [MaxLength(100)]
        [Display(Name = "Previous SAP invoice code")]
    ...
    public partial class BG_Forecast_item : IEquatable<BG_Forecast_item>
    {
            ...
            get
            {
                ...
                switch (ElementoIHS.tipo)
                {
                    ...
                    case TipoElementoIHS.DIVISION:
                        ...
                        break;
                    case TipoElementoIHS.HECHIZO:
                        clave = "H_" + BG_ihs_vehicle_custom.Id;
                        break;
                }
        ...
        public RelElementoIHS ElementoIHS
        {
            get
            {
                ...
                else if (BG_ihs_vehicle_custom != null)
                {
                    RelElemento.BG_ihs_vehicle_custom = BG_ihs_vehicle_custom;
                    RelElemento.tipo = TipoElementoIHS.HECHIZO;
                    RelElemento.descripcion = BG_ihs_vehicle_custom.Vehicle;
                    RelElemento.descripcionTipo = "Hechizo";
                }
        ...
        [NotMapped]
        [Display(Name = "IHS Concatenado")]
        public string ihs_concatenado
        {
            get
            {
                return this.BG_IHS_item != null ? this.BG_IHS_item.ConcatCodigo : this.BG_IHS_combinacion != null ? this.BG_IHS_combinacion.vehicle :
                    this.BG_IHS_rel_division != null ? this.BG_IHS_rel_division.vehicle : "TBD";
        ...
        public string production_nameplate
        {
            get
            {
                return this.BG_IHS_item != null ? this.BG_IHS_item.production_nameplate : this.BG_IHS_combinacion != null ? this.BG_IHS_combinacion.production_nameplate :
                    this.BG_IHS_rel_division != null ? this.BG_IHS_rel_division.BG_IHS_division.BG_IHS_item.production_nameplate : "TBD";
        ...
        public string oem
        {
            get
            {
                return this.BG_IHS_item != null ? this.BG_IHS_item.manufacturer_group : this.BG_IHS_combinacion != null ? this.BG_IHS_combinacion.manufacturer_group :
                    this.BG_IHS_rel_division != null ? this.BG_IHS_rel_division.BG_IHS_division.BG_IHS_item.manufacturer_group : "TBD";
        ...
        public string material_short
        {
            get
            {
                string result = string.Empty;
                if (!string.IsNullOrEmpty(this.material_type))
                {
                    if (this.material_type.ToUpper().Contains("STEEL"))
                        result = "STEEL";
                    else if (this.material_type.ToUpper().Contains("ALU"))
                        result = "ALU";
                }
        ...
        public bool Equals(BG_Forecast_item other)
        {
            ...
            return
                ...
                && this.trans_silao_slp == other.trans_silao_slp
                && this.wooden_pallet_usd_part == other.wooden_pallet_usd_part
                && this.packaging_price_usd_part == other.packaging_price_usd_part
                && this.neopreno_usd_part == other.neopreno_usd_part
                ;
        }
    ...
    public class RelElementoIHS
    {
        ...
        public BG_ihs_vehicle_custom BG_ihs_vehicle_custom { get; set; }
