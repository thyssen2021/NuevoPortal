...
{
    public static class GV_solicitud_estatus
    {
        ...
        public const string CONFIRMADO_USUARIO = "CONFIRMADO_USUARIO";
        public const string RECHAZADO_USUARIO = "RECHAZADO_USUARIO";
        ...
        public static string DescripcionStatus(String status)
        {
            ...
            switch (status)
            {
                case GV_solicitud_estatus.CREADO:
                    return "Creado";
                case GV_solicitud_estatus.ENVIADO_A_JEFE:
                    return "Enviado a Jefe";
                case GV_solicitud_estatus.RECHAZADO_JEFE:
                    return "Rechazado por Jefe";
                case GV_solicitud_estatus.ENVIADO_CONTROLLING:
                    return "Enviado a Controlling";
                case GV_solicitud_estatus.RECHAZADO_CONTROLLING:
                    return "Rechazado Controlling";
                case GV_solicitud_estatus.CONFIRMADO_NOMINA:
                    return "Confirmado por Nóminas";
                case GV_solicitud_estatus.RECHAZADO_CONTABILIDAD:
                    return "Rechazado Cuentas por Pagar";
                case GV_solicitud_estatus.ENVIADO_NOMINA:
                    return "Enviado a Nómina";
                case GV_solicitud_estatus.RECHAZADO_NOMINA:
                    return "Rechazado Nómina";
                case GV_solicitud_estatus.FINALIZADO:
                    return "Finalizado";
                case GV_solicitud_estatus.CONFIRMADO_CONTABILIDAD:
                    return "Confirmado Cuentas por Pagar";
                 case GV_solicitud_estatus.ENVIADO_CONTABILIDAD:
                    return "Enviado a Cuentas por Pagar";
                case GV_solicitud_estatus.CONFIRMADO_USUARIO:
                    return "Confirmado usuario";
                case GV_solicitud_estatus.RECHAZADO_USUARIO:
                    return "Rechazado usuario";
