...
BEGIN
	...
	BEGIN
		INSERT INTO [dbo].[AspNetRoles]([Id],[Name],[descripcion])VALUES(LOWER(NEWID()) ,'SCDM_MM_REPORTES',N'Acceso a los reportes y métricas de Master Data MM.')
	END
	
	IF NOT EXISTS (SELECT * FROM [dbo].[AspNetRoles] where Name='SCDM_MM_APROBACION_INICIAL_SOLICITUDES' )
	BEGIN
		INSERT INTO [dbo].[AspNetRoles]([Id],[Name],[descripcion])VALUES(LOWER(NEWID()) ,'SCDM_MM_APROBACION_INICIAL_SOLICITUDES',N'Permiso para aprobar solicitudes iniciales.')
	END
