--use[Portal_2_0]
DROP VIEW IF EXISTS dbo.view_SCDM_solicitud_cambios_ingenieria;  
/*****************************************************************************
*  Tipo de objeto: View
...
GO
CREATE VIEW [dbo].view_SCDM_solicitud_cambios_ingenieria AS

select cr.*, tm.descripcion as tipo_material, p.codigoSap,
CASE
