...
CREATE TABLE [dbo].[SCDM_solicitud_asignaciones](
	...
	[id_departamento_asignacion][int] NOT NULL,
...
alter table [dbo].[SCDM_solicitud_asignaciones]
 add constraint FK_SCDM_solicitud_asignaciones_id_solicitud
  ...
  -- restriccion de clave foranea
alter table [dbo].[SCDM_solicitud_asignaciones]
 add constraint FK_SCDM_solicitud_asignaciones_id_empleado
  foreign key (id_empleado)
  references empleados(id);

    -- restriccion de clave foranea
alter table [dbo].[SCDM_solicitud_asignaciones]
 add constraint FK_SCDM_solicitud_asignaciones_id_departamento_asignacion
  foreign key (id_departamento_asignacion)
