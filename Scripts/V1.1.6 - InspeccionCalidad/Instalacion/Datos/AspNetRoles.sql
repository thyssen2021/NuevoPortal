...
BEGIN
	...
	IF NOT EXISTS (SELECT * FROM [dbo].[AspNetRoles] where Name='Inspeccion_registros' )
	BEGIN
		INSERT INTO [dbo].[AspNetRoles]([Id],[Name])VALUES(LOWER(NEWID()) ,'Inspeccion_registros')
	END
	-- gestion de catálogos
	IF NOT EXISTS (SELECT * FROM [dbo].[AspNetRoles] where Name='Inspeccion_catalogos' )
	BEGIN
		INSERT INTO [dbo].[AspNetRoles]([Id],[Name])VALUES(LOWER(NEWID()) ,'Inspeccion_catalogos')
	END
	-- reportes de inspeccion
	IF NOT EXISTS (SELECT * FROM [dbo].[AspNetRoles] where Name='Inspeccion_reportes' )
	BEGIN
		INSERT INTO [dbo].[AspNetRoles]([Id],[Name])VALUES(LOWER(NEWID()) ,'Inspeccion_reportes')
	END
