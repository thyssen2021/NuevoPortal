...
BEGIN
	...
	IF NOT EXISTS (SELECT * FROM [dbo].[AspNetRoles] where Name='CTZ_Acceso' )
	BEGIN
		INSERT INTO [dbo].[AspNetRoles]([Id],[Name],descripcion)VALUES(LOWER(NEWID()) ,'CTZ_Acceso', 'Permite visualizar el menu del Cotizador, los permisos se administran en CTZ_User_Roles')
	END
