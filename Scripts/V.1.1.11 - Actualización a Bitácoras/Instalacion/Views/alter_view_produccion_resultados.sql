...
SELECT 				
	...
	,(SELECT TOP (1) [Net weight] FROM mm_v3 WHERE Material=pr.sap_platina_2) AS [Peso neto SAP_platina2]
	,(SELECT TOP (1) [Gross weight] FROM mm_v3 WHERE Material=pr.sap_platina_2) AS [Peso Bruto SAP_platina2]
