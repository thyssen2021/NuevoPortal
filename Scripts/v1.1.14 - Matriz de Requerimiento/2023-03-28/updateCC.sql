...
update empleados set correo='ana.casas@lagermex.com.mx' where [8ID] = '10509648'

UPDATE empleados set planta_clave=3 where [8ID] = '10351408'
UPDATE empleados set planta_clave=3 where [8ID] = '10383874'
UPDATE empleados set planta_clave=3 where [8ID] = '10509648'
UPDATE empleados set planta_clave=3 where [8ID] = '10509751'
UPDATE empleados set planta_clave=3 where [8ID] = '10509753'
UPDATE empleados set planta_clave=3 where [8ID] = '10520023'
UPDATE empleados set planta_clave=3 where [8ID] = '10619223'
UPDATE empleados set planta_clave=3 where [8ID] = '10631420'
UPDATE empleados set planta_clave=3 where [8ID] = '10660784'
UPDATE empleados set planta_clave=3 where [8ID] = '10681014'
UPDATE empleados set planta_clave=3 where [8ID] = '10681879'
UPDATE empleados set planta_clave=3 where [8ID] = '10681880'
UPDATE empleados set planta_clave=3 where [8ID] = '10681881'
UPDATE empleados set planta_clave=3 where [8ID] = '10681882'
UPDATE empleados set planta_clave=3 where [8ID] = '10681883'
UPDATE empleados set planta_clave=3 where [8ID] = '10681885'
UPDATE empleados set planta_clave=3 where [8ID] = '10681886'
UPDATE empleados set planta_clave=3 where [8ID] = '10681887'
UPDATE empleados set planta_clave=3 where [8ID] = '10681888'
UPDATE empleados set planta_clave=3 where [8ID] = '10707267'
UPDATE empleados set planta_clave=3 where [8ID] = '10710097'
UPDATE empleados set planta_clave=3 where [8ID] = '10715017'
UPDATE empleados set planta_clave=3 where [8ID] = '10715019'
UPDATE empleados set planta_clave=3 where [8ID] = '10715020'
UPDATE empleados set planta_clave=3 where [8ID] = '10715021'
UPDATE empleados set planta_clave=3 where [8ID] = '10715022'
UPDATE empleados set planta_clave=3 where [8ID] = '10715023'
UPDATE empleados set planta_clave=3 where [8ID] = '10715024'

update empleados set id_area='51', id_jefe_directo='425' where [8id]='10351408'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10509648'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10619223'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10631420'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10660784'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10681879'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10681880'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10681881'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10681882'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10681883'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10681885'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10681886'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10681887'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10681888'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10707267'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10710097'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10715017'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10715019'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10715020'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10715021'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10715022'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10715023'
update empleados set id_area='51', id_jefe_directo='425' where [8id]='10715024'
