...
IF OBJECT_ID ('dbo.view_valores_fiscal_year', 'V') IS NOT NULL  
DROP VIEW [dbo].[view_valores_fiscal_year];  
GO  

/****** Object:  View [dbo].[view_valores_fiscal_year]    Script Date: 23/02/2023 01:53:23 p.m. ******/
SET ANSI_NULLS ON
GO
