...
UPDATE budget_cuenta_sap set id_mapping =14, sap_account= '708190', name = 'Materiales Para Embalaje', activo=1, aplica_formula=1, formula = 'a+b+c+d+e', aplica_mxn = 1, aplica_usd= 0, aplica_eur=0, aplica_gastos_mantenimiento=0 where id=114
