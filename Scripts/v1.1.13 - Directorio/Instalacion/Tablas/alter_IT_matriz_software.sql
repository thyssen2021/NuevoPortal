...
CREATE TABLE [IT_matriz_software](
	...
	[id_it_asignacion_software][int] NULL,
...
alter table [IT_matriz_software]
 add constraint FK_IT_matriz_software_id_it_software
  ...
  references IT_inventory_software(id);
    ...
    -- restriccion de clave foranea
alter table [IT_matriz_software]
 add constraint FK_IT_matriz_hardware_id_it_asignacion_software
  foreign key (id_it_asignacion_software)
  references IT_asignacion_software(id);
