...
IF object_id(N'sp_reporte_pesadas_silao','P') IS NOT NULL
BEGIN
      DROP PROCEDURE [dbo].[sp_reporte_pesadas_silao]
      PRINT '<<< STORED PROCEDURE [dbo].[sp_reporte_pesadas_silao] en Base de Datos:' + 
	  db_name() + ' en el Servidor:' + @@servername + ' se ha ELIMINADO! >>>'
END
GO
CREATE PROCEDURE [dbo].[sp_reporte_pesadas_silao]
/*****************************************************************************
...
AS   
    ...
    -- Insert statements for procedure here  
        ...
        SELECT 
		  ...
		  FROM [cube_tkmm].[dbo].[view_detalle_pesada_union_silao]
...
ELSE
	BEGIN
	      PRINT '<<< No ha sido posible crear el STORED PROCEDURE [dbo].[sp_reporte_pesadas_silao] en ' +
